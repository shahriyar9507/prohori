    ...
    <div>
      ...
      {pic && (
        <div className="tiles" style={{ gridTemplateColumns: `repeat(${pic.counts.sar > 0 ? 4 : 3}, 1fr)` }}>
          ...
          {pic.counts.sar > 0 && <div className="tile"><div className="num" style={{ color: '#94a3b8' }}>{pic.counts.sar}</div><div className="lbl">{t.sarDetections}</div></div>}
      ...
      <div className="map-wrap">
        <div>
          ...
          <div className="legend">
            ...
            {pic?.counts?.sar > 0 && <span><i style={{ background: '#64748b' }} />{t.sarDetections}</span>}
